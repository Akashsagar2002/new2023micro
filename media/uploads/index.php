	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item"><a href="pricing.html" class="nav-link"><button type="button" class="btn btn-success">Feedback</button></a></li>
  ...
  <div class="modal-dialog" style="background: #eaeaeabf;">
    ...
    <div class="modal-content" style="background: #eaeaeabf;">
      ...
      <div class="modal-body">
        <form action="index.php" method="post" name="enquiry_form">
